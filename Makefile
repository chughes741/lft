...
SRCDIR	=	src/
OBJDIR	=	bin/
SRCS	=	src/ft_atoi.c src/ft_bzero.c src/ft_calloc.c src/ft_chr_prepend.c\
			src/ft_format.c src/ft_format_str.c src/ft_get_mods.c\
			src/ft_isalnum.c src/ft_isalpha.c src/ft_isascii.c src/ft_isdigit.c\
			src/ft_isprint.c src/ft_itoa.c src/ft_itox.c src/ft_left_justify.c\
			src/ft_linelen.c src/ft_lstadd_back.c src/ft_lstadd_front.c\
			src/ft_lstclear.c src/ft_lstdelone.c src/ft_lstiter.c\
